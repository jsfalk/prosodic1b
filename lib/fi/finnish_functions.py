...
# note: as suggested by Anttila (p.c.), the consonants are split if there is only one vowel to the left or right of the consonants
# this works because Karlsson's rule is designed to handle compounds, but Finnish words must contain at least two vocalic moras
...
CONSONANTS = set([u'b', u'c', u'd', u'f', u'g', u'h', u'j', u'k', u'l', u'm', u'n', u'p', u'q', u'r', u's', u't', u'v', u'w', u'x', u'z', u"'"]) # ' included for purposes of words like vaa'an

# following Anttila 2008 on Finnish stress (p. 5)
SON_HIGH = set([u'i', u'e', u'u', u'y'])
SON_LOW = set([u'a', u'ä', u'o', u'ö'])
...
def to_ipa(word):
	return word.replace(u'a', u'ɑ').replace(u'ä', u'æ').replace(u'ö', u'ø')